...
// Handling request for about page
app.get("/about", function (req, res) {
	res.render("about", { aboutContent: aboutContent });
});

// Handling get request for contact page
app.get("/contact", function (req, res) {
	res.render("contact", { contactContent: contactContent });
});

// Handling get request for compose page
app.get("/compose", function (req, res) {
	res.render("compose");
});

// Handling post request of publishing post
...
// Hanlding any route get request
